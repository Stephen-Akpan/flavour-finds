...
const RecipeCard = React.memo(({ recipe, onClick, isLoggedIn, toggleSaveRecipe, handleShare, savedRecipes }) => (
  <div 
      ...
      <div className="recipe-footer">
        ...
        <div className="recipe-actions">
          <button 
            ...
            aria-label={savedRecipes.includes(recipe.id) ? 'Unsave recipe' : 'Save recipe'}
          >
